...
import com.google.android.exoplayer.multitv.DefaultLoadControl;
import com.google.android.exoplayer.multitv.LoadControl;
...
import com.google.android.exoplayer.multitv.hls.DefaultHlsTrackSelector;
import com.google.android.exoplayer.multitv.hls.HlsChunkSource;
import com.google.android.exoplayer.multitv.hls.HlsMasterPlaylist;
import com.google.android.exoplayer.multitv.hls.HlsPlaylist;
import com.google.android.exoplayer.multitv.hls.HlsPlaylistParser;
import com.google.android.exoplayer.multitv.hls.HlsSampleSource;
import com.google.android.exoplayer.multitv.hls.PtsTimestampAdjusterProvider;
import com.google.android.exoplayer.multitv.metadata.MetadataTrackRenderer;
import com.google.android.exoplayer.multitv.metadata.id3.Id3Frame;
import com.google.android.exoplayer.multitv.metadata.id3.Id3Parser;
import com.google.android.exoplayer.multitv.text.TextTrackRenderer;
import com.google.android.exoplayer.multitv.text.eia608.Eia608TrackRenderer;
...
import com.google.android.exoplayer.multitv.util.ManifestFetcher.ManifestCallback;
...
public class HlsRendererBuilder implements MediaPlayer.RendererBuilder {
  ...
  private static final class AsyncRendererBuilder implements ManifestCallback<HlsPlaylist> {
    ...
    public AsyncRendererBuilder(Context context, String userAgent, String url, MediaPlayer player) {
      this.context = context;
      this.userAgent = userAgent;
      this.player = player;
    ...
    public void onSingleManifest(HlsPlaylist manifest) {
      ...
      HlsSampleSource sampleSource = new HlsSampleSource(chunkSource, loadControl,
          MAIN_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, MediaPlayer.TYPE_VIDEO);
      ...
      if (haveSubtitles) {
        ...
        HlsSampleSource textSampleSource = new HlsSampleSource(textChunkSource, loadControl,
            TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, MediaPlayer.TYPE_TEXT);
