...
public class GPSTracker extends Service implements LocationListener {
    ...
    private boolean isAccessCoarseLocationPermissionEnabled, isAccessFineLocationPermissionEnabled;
    ...
    public GPSTracker(Context context) {
        ...
        /*if(checkForRuntimePermissions(context))*/
            getLocation();
    }

   /* private boolean checkForRuntimePermissions(Context context) {
   ...
   /* @Override
    public void permissionStatusSuccessful(int requestCode) {
        if(requestCode == PermissionId.PERMISSION_ACCESS_COARSE_LOCATION_REQUEST_CODE)
            isAccessCoarseLocationPermissionEnabled = true;
        else if(requestCode == PermissionId.PERMISSION_ACCESS_FINE_LOCATION_REQUEST_CODE)
            isAccessFineLocationPermissionEnabled = true;
    ...
    @Override
    public void permissionStatusDenied(int requestCode) {
        if(requestCode == PermissionId.PERMISSION_ACCESS_COARSE_LOCATION_REQUEST_CODE ||
                requestCode == PermissionId.PERMISSION_ACCESS_FINE_LOCATION_REQUEST_CODE)
            Toast.makeText(mContext, "Location permission is denied by user", Toast.LENGTH_SHORT).show();
    }*/
}