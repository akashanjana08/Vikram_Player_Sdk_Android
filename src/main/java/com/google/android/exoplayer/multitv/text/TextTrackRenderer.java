 ...
 */
package com.google.android.exoplayer.multitv.text;
...
import com.google.android.exoplayer.multitv.SampleSourceTrackRenderer;
 ...
 *
 * <ul>
 * <li>WebVTT ({@link com.google.android.exoplayer.multitv.text.webvtt.WebvttParser})</li>
 * <li>TTML
 * ({@link com.google.android.exoplayer.multitv.text.ttml.TtmlParser})</li>
 * <li>SubRip
 * ({@link com.google.android.exoplayer.multitv.text.subrip.SubripParser})</li>
 * <li>TX3G
 * ({@link com.google.android.exoplayer.multitv.text.tx3g.Tx3gParser})</li>
 * </ul>
 *
  ...
  static {
    ...
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.text.webvtt.WebvttParser")
    ...
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.text.ttml.TtmlParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.text.webvtt.Mp4WebvttParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.text.subrip.SubripParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.text.tx3g.Tx3gParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
