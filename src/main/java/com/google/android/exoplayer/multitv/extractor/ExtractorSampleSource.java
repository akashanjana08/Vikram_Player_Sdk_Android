 ...
 */
package com.google.android.exoplayer.multitv.extractor;
...
import com.google.android.exoplayer.multitv.MediaFormat;
import com.google.android.exoplayer.multitv.MediaFormatHolder;
import com.google.android.exoplayer.multitv.ParserException;
import com.google.android.exoplayer.multitv.SampleHolder;
import com.google.android.exoplayer.multitv.SampleSource;
import com.google.android.exoplayer.multitv.SampleSource.SampleSourceReader;
import com.google.android.exoplayer.multitv.TrackRenderer;
import com.google.android.exoplayer.multitv.drm.DrmInitData;
...
import com.google.android.exoplayer.multitv.upstream.Loader;
import com.google.android.exoplayer.multitv.upstream.Loader.Loadable;
import com.google.android.exoplayer.multitv.util.Assertions;
 ...
 *
 * <ul>
 * <li>MP4, including M4A ({@link com.google.android.exoplayer.multitv.extractor.mp4.Mp4Extractor})</li>
 * <li>fMP4 ({@link com.google.android.exoplayer.multitv.extractor.mp4.FragmentedMp4Extractor})</li>
 * <li>Matroska and WebM ({@link com.google.android.exoplayer.multitv.extractor.webm.WebmExtractor})</li>
 * <li>Ogg Vorbis/FLAC ({@link com.google.android.exoplayer.multitv.extractor.ogg.OggExtractor}</li>
 * <li>MP3 ({@link com.google.android.exoplayer.multitv.extractor.mp3.Mp3Extractor})</li>
 * <li>AAC ({@link com.google.android.exoplayer.multitv.extractor.ts.AdtsExtractor})</li>
 * <li>MPEG TS ({@link com.google.android.exoplayer.multitv.extractor.ts.TsExtractor})</li>
 * <li>MPEG PS ({@link com.google.android.exoplayer.multitv.extractor.ts.PsExtractor})</li>
 * <li>FLV ({@link com.google.android.exoplayer.multitv.extractor.flv.FlvExtractor})</li>
 * <li>WAV ({@link com.google.android.exoplayer.multitv.extractor.wav.WavExtractor})</li>
  ...
  static {
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.extractor.webm.WebmExtractor")
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.extractor.mp4.FragmentedMp4Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.extractor.mp4.Mp4Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.extractor.mp3.Mp3Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.extractor.ts.AdtsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.extractor.ts.TsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.extractor.flv.FlvExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.extractor.ogg.OggExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.extractor.ts.PsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.extractor.wav.WavExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.google.android.exoplayer.multitv.ext.flac.FlacExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
